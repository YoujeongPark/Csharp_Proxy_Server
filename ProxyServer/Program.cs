...
namespace ProxyServer
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var server = new ProxyServer("http://127.0.0.1:5425/", "http://127.0.0.1:5001/", "http://127.0.0.1:5002/"))
            {
                //server.StartAsync();
                server.ServerStart();
    ...
    public class ProxyServer : IDisposable
    {
        ...
        public void ServerStart()
        {
            ...
            /*while (true)
            {
                ...
                await ctx.Response.OutputStream.WriteAsync(data2, 0, data2.Length);
            }*/
